        ...
        <div className="pointer-events-none relative z-10">
          <Reveal>
            <h1 className="pointer-events-auto text-4xl sm:text-6xl font-black text-zinc-100 md:text-8xl">
              Hi, I'm Wasif<span className="text-indigo-500">.</span>
            </h1>
          </Reveal>
          <Reveal>
          ...
          <Reveal>
            <p className="pointer-events-auto leading-relaxed md:leading-relaxed max-w-xl text-sm text-zinc-300 md:text-base">
              Currently, I'm working on developing and optimizing the Rank2Revenue
              website. I focus on building high-conversion, responsive web
              experiences using technologies like Next.js, Supabase, and Tailwind CSS.
